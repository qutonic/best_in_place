...
BestInPlaceEditor.prototype = {
  ...
  update : function() {
    ...
    if (this.formType == "select") {
      ...
      if (this.collectionClasses !== null) {
        editor.element.toggleClass(this.valueClasses[1]).toggleClass(this.valueClasses[0])
      }
  ...
  initOptions : function() {
    ...
    self.element.parents().each(function(){
      ...
      self.collectionClasses = self.collectionClasses || $parent.attr("data-collection-classes");
    });
    ...
    self.collectionClasses = self.element.attr("data-collection-classes")  || self.collectionClasses || null;
    ...
    if ((self.formType == "checkbox") && self.collectionClasses !== null)
    {
      self.valueClasses = jQuery.parseJSON(self.collectionClasses);
    }
